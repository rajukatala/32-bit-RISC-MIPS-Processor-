...
HD_PWD='C:/Users/admin/VIVADO project/MIPS_32_RISC_PROCESSOR_WITH_5_STAGE_PIPELNE/MIPS_32_RISC_PROCESSOR_WITH_5_STAGE_PIPELNE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS32_PIPELINE.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MIPS32_PIPELINE.tcl
